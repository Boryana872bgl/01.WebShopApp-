...
namespace WebShopApp.Indrastructure.Data.Infrastructure
{
    public static class ApplicationBuilderExtension
    {
        ...
        private static void SeedCategories(ApplicationDbContext dataCategory)
        {
            ...
            new Category {CategoryName="Keychains"},
            new Category {CategoryName="Women Clothes"},
            new Category {CategoryName="Men Clothes"},
            new Category {CategoryName="For Winter"},
            new Category {CategoryName="For Summer"},
            new Category {CategoryName="For Baby"},
        });
